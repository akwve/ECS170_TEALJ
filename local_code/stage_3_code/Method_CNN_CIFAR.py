...
class CNN_CIFAR(method, nn.Module):
    ...
    def __init__(self, mName, mDescription):
        ...
        # padding = control the amount of implicit zero-padding)

        # Input: 3x32x32
        # After conv1: 32x30x30
        # After pool1: 32x15x15
        # After conv2: 64x13x13
        # After pool2: 64x6x6

        self.conv_layer_1 = nn.Conv2d(3, self.num_filters_1, kernel_size=self.kernel_size)
