...
class Method_RNN_GRU(method, nn.Module):
    data = None
    # it defines the max rounds to train the model
    max_epoch = 11
    # it defines the learning rate for gradient descent based optimizer for model learning
    ...
    def __init__(self, mName, mDescription):
        ...
        self.gru = nn.GRU(input_size=128, hidden_size=128,batch_first=True,bidirectional=True)
...
class Method_RNN(method, nn.Module):
    ...
    def __init__(self, mName, mDescription):
        ...
        self.rnn = nn.RNN(input_size=128, hidden_size=128,batch_first=True)
