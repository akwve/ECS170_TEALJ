...
if 1:
    ...
    data_obj = Dataset_Loader('RNN Based Generator', '')
    ...
    method_obj = Method_RNN_Generator('RNN Based Generator', '', starters, vs, arch='RNN')
    ...
    setting_obj = Setting_Generator('RNN Based Generator', '')
